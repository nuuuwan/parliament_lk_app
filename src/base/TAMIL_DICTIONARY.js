const TAMIL_DICTIONARY = {
  ...
  "80 - 90": "80 - 90",
  "85 - 90": "85 - 90",
  "Advanced LevelsOr Higher": "மேம்பட்ட நிலைகள்கள் அல்லது அதற்கு மேல்",
  ACMC: "ஏசிஎம்சி",
  AITC: "ஏஐடிசி",
  "Age > 40": "வயது > 40",
  "Age > 50": "வயது > 50",
  ...
  "Has Advanced Levels or higher?": "ஏ. நிலைகள் அல்லது அதற்கு மேல் உள்ளதா?",
  ...
  "ISCED2 Lower Secondary (O. Levels)": "ISCED2 லோயர் செகண்டரி (சாதாரண தர)",
  "ISCED3 Upper Secondary (A. Levels)": "ISCED3 மேல்நிலை (மேம்பட்ட நிலைகள்கள்)",
  "ISCED4 Post-Secondary": "ISCED4 பிந்தைய இரண்டாம் நிலை",
  "ISCED6 Bachelors": "ISCED6 இளங்கலை",
  "ISCED7 Masters": "ISCED7 முதுநிலை",
  ...
  'Statistical Trends measure if certain grid cells contain more MPs than we would expect if they were assigned at random.  The "z" (e.g. z = 2.5) value shows how many standard deviations the number of MPs vary from the mean number of expected MPs. The range (e.g. 84 - 114) is the 95% confidence interval for the number of MPs. If the actual number is outside this range, the probability that the trend is random is <5%.':
    'சில கிரிட் செல்கள் சீரற்ற முறையில் ஒதுக்கப்பட்டால் நாம் எதிர்பார்ப்பதை விட அதிகமான எம்.பி.க்கள் இருந்தால், புள்ளியியல் போக்குகள் அளவிடுகின்றன. "z" (எ.கா. z = 2.5) மதிப்பு, எம்.பி.க்களின் எண்ணிக்கை எதிர்பார்க்கப்படும் எம்.பி.க்களின் சராசரி எண்ணிக்கையிலிருந்து எத்தனை நிலையான விலகல்கள் மாறுபடுகிறது என்பதைக் காட்டுகிறது. வரம்பு (எ.கா. 84 - 114) என்பது எம்.பி.க்களின் எண்ணிக்கைக்கான 95% நம்பிக்கை இடைவெளி. உண்மையான எண் இந்த வரம்பிற்கு வெளியே இருந்தால், போக்கு சீரற்றதாக இருப்பதற்கான நிகழ்தகவு <5% ஆகும்.',
  TMTK: "டிஎம்டிகே",
  TMVP: "டி.எம்.வி.பி",
  ...
  "Voted: In Favour": "வாக்களித்தது: ஆதரவாக",
